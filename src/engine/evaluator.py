...
from engine.scoring import compute_category_scores, compute_score
from ir.model import InfrastructureDocument
from policies.base import Policy
from policies.builtin import ALL_BUILTIN_POLICIES
...
class Evaluator:
    ...
    def run(self, document: InfrastructureDocument, contract: Contract) -> EvaluationResult:
        ...
        has_blocking_failure = any(not f.passed and f.severity in fail_on for f in findings)

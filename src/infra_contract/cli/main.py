...
from infra_contract.cli.check import run_check
from infra_contract.cli.explain import run_explain
from infra_contract.cli.fix import run_fix
from infra_contract.cli.init_cmd import run_init
from infra_contract.cli.plan import run_diff, run_plan
...
def check(
    ...
    fail_on: str | None = typer.Option(
        None, "--fail-on", help="Minimum severity that fails the command (overrides contract ci.fail_on)."
    ),
) -> None:
...
def mcp(
    ...
    from infra_contract.mcp.server import serve

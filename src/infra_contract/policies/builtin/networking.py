...
class ProductionDatabasePrivatePolicy(Policy):
    ...
    def evaluate(self, resource: Resource, contract: Contract) -> Finding:
        ...
        return Finding(
            ...
            remediation="Move the database to a private subnet with no public route."
            if violated
            else None,
        )
...
class RestrictedIngressPolicy(Policy):
    ...
    def evaluate(self, resource: Resource, contract: Contract) -> Finding:
        ...
        return Finding(
            ...
            remediation="Restrict ingress to known CIDR ranges or a load balancer security group."
            if open_to_world
            else None,
        )
